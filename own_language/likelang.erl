-file("e:/erlang/erl-25.0.2/lib/parsetools-2.4/include/leexinc.hrl", 0).
...
-file("./likelang.xrl", 46).
%% Purpose : Token definitions for LikeLang.

-file("e:/erlang/erl-25.0.2/lib/parsetools-2.4/include/leexinc.hrl", 14).
